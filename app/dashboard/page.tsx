...
import { Plus, Users, FileText, Search, Settings, LogOut, LayoutDashboard } from "lucide-react";
        ...
        <div className="flex h-screen bg-slate-50 text-slate-900 font-sans">
            ...
            <aside className="w-64 bg-slate-900 text-slate-300 flex flex-col">
                ...
                <nav className="flex-1 p-4 space-y-1">
                    <a href="#" className="flex items-center gap-3 px-3 py-2 bg-blue-600/10 text-blue-400 rounded-lg border border-blue-900/50">
                        <LayoutDashboard size={18} />
                        Visão Geral
                    </a>
                    <a href="#" className="flex items-center gap-3 px-3 py-2 hover:bg-slate-800 rounded-lg transition-colors">
                        <Users size={18} />
                        Clientes
                    </a>
                    <a href="#" className="flex items-center gap-3 px-3 py-2 hover:bg-slate-800 rounded-lg transition-colors">
                ...
                <div className="p-4 border-t border-slate-800">
                    <button className="flex items-center gap-3 w-full px-3 py-2 text-red-400 hover:bg-red-900/20 rounded-lg transition-colors">
                        <LogOut size={18} />
                        Sair
                    </button>
                </div>
                ...
                <header className="h-16 bg-white border-b border-slate-200 flex items-center justify-between px-8">
                    ...
                    <div className="flex items-center gap-4">
                        <div className="relative">
                            ...
                            <input type="text" placeholder="Buscar..." className="pl-10 pr-4 py-2 border border-slate-200 rounded-lg text-sm focus:outline-none focus:border-blue-500 w-64" />
                        </div>
                ...
                <div className="flex-1 overflow-auto p-8">
                    ...
                    <div className="flex justify-between items-center mb-8">
                        <div>
                            ...
                            <p className="text-slate-500">Bem-vindo de volta, Luiz.</p>
                        </div>
                        <button className="bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-lg font-medium flex items-center gap-2 shadow-sm transition-all">
                            <Plus size={18} />
                            Nova Proposta
                        </button>
                    </div>
